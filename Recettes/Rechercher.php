<?php
include_once '../General/GestionConnexion.php';
include_once '../Donnees.inc.php' ?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Rechercher une recette | MyCocktailBox</title>
    ...
    <script type="text/javascript" >
        ...
        function afficherSuggestions(){
            ...
            if(nbCarac>0){
                ...
                /*
                 * On itére sur chaque aliment pour voir si le début correspond au premiers caractères de l'aliments
                 */
                for(let i=0; i<liste_aliments.length; i++){
                    if(liste_aliments[i].length>nbCarac-1){
                        ...
                        if(!saisie.toLowerCase().localeCompare(liste_aliments[i].substr(0,nbCarac).toLowerCase())){
                             ...
                             * Si on appuie sur ce div, on change la valeur de l'entrée texte avec l'aliment sélectionnée
                             */
