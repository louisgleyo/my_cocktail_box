...
function genererImage($nom_recette) {
     ...
     * dont je me suis servi pour m'assurer qu'aucun accent ne manquait.
     */
    ...
    if($F) {
        ...
        return "<span class=\"image fit\"><img src=\"../Photos/default.png\" alt=\"Photo par défaut\" ></span>";
    }
...
function genererFicheRecette($recette,$note){
    ...
    /*
     * Après que l'on ait vérifié que la recette contient les bons champs, on génère la fiche avec
    ...
    if(isset($recette['titre'])&&isset($recette['ingredients'])&&isset($recette['preparation'])){
        ...
        /*
         * Création du bouton pour gérer les recettes favoris
         */
        global $mysqli;
        ...
        // ajout du bouton a l'affichage
        $affichage.=
            "<li><button class=\"".$cl."\" " .
            "onclick=\"gererListeFavoris(this,'".addslashes($titre)."',".$ajouter.")\">"
            .$texte."</button></li>";
