...
/*
 * traitement des données recu si le formulaire a été validé
 */
$chk_login = true;
$chk_mdp = true;
...
<head>
    ...
    <title>Mon compte | MyCocktailBox</title>
        ...
        <form name="formulaire" method="post" action=# >
            <table class="alt">
                ...
                <tr><td></td><td>
                        ...
                        <input type="button" onclick="window.location.href = 'Compte.php';" value="Annuler"/>
                    </td></tr>
                </tfoot>
            </table>
        </form>
